...
import {
    ...
    StyledTodayButton,
    styles,
} from './employee-layout.styles';

import { SwxTypography, SwxTabs, SwxButtonGroup, SwxCalenderInput } from '../../components';
import { Icon } from '../../icons';

const employeeScheduleTabs = [
    { label: 'Overview', step: 'overview' },
    { label: 'Shift Board', step: 'shift_board' },
    { label: 'PTO', step: 'pto' },
];

export default function EmployeeScheduleLayout({ children }) {
    ...
    return (
        <>
            <Stack direction='column' spacing={5} sx={{ mt: 7 }}>
                ...
                <SwxTabs tabs={employeeScheduleTabs} currentStep={currentStep} />
            </Stack>
            {children}
        </>
    );
